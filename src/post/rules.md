...
> 브런치는 타인에게 불편을 끼치지 않으며, 둥글둥글한 관계를 만들어 나가는 길드예요 🍰
...
- 돌발적인 상황에서 튀어나오는 욕설은 수위에 따라 실수로 인정 가능하나 사과 필수
  - (예시) 너무 먹고 싶었던 아이템 드랍
  - 동일한 내용으로 재차 반복 시 경고 부여하며, **2회 경고 추방**
- 타인을 불편하게 하거나 사회적 기준에서 벗어난 욕설 금지
  - 수위에 따라 **2회 경고 추방** 또는 **경고 없이 추방**
...
- 모든 형태의 성적 언행 금지 **경고 없이 추방**

## ④ 부정적인 대화 자제

- 불필요한 징징이나 부정적 언행은 길드 분위기를 해치므로 자제
- 수위에 따라 **2회 경고 추방** 또는 **경고 없이 추방**

## ⑤ 정치적 대화 금지

- 국가적 이슈에 대한 걱정은 허용하나, 이분법적 논쟁이 되는 순간 **경고 없이 추방**

<br />

# 아이템 링크

> 기본적으로 허용하지만, 긍정적인 메시지(피드백) 주고 받는 분위기가 중요해요 🙏

## ① 징징 금지

- 타인이 봤을 때 불편할 수 있는 내용

## ② 링크를 할 거면, 타인이 올린 링크에 대해서도 긍정적인 메시지(피드백) 건네기

- 자신이 축하를 받고 싶다면, 득템을 한 다른 길드원도 동일하게 축하해 주기
...
- 이중 길드 점검은 불시 진행
- 사전에 알리지 않은 길드 확인 시 경고 부여 -> **2회 경고 추방**

<br />

# 길드 공대

> 🔥 서로를 배려하고, 함께 성장하며 나아가는 것을 목표로 하고 있습니다.
...
- 패턴 미숙으로 인한 피해를 주지 않도록 사전에 최대한 해결하기
  ...
  - 실수가 재차 발생하는 패턴은 운영진의 언급 후, 함께 복기하는 시간 진행 **개인 의지 중요!**
...
경고 진행 시 내용과 이를 보충하는 스크린샷이 함께 기록되며, 추방 시 해당 자료 제공과 함께 이를 근거로 삼아 진행합니다.
